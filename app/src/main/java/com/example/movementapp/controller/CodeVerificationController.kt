...
class CodeVerificationController(APICallBack: RideeAPI.APICallBack?) {
    ...
    fun start(codeVerification: CodeVerification) {
        ...
        val call: Call<ResponseAPI?>? = rideeAPI.codeVerification(codeVerification)
